...
troop.postpone(bookworm, 'EntityBound', function () {
    ...
    bookworm.EntityBound = troop.Base.extend()
        ...
        .addMethods(/** @lends bookworm.EntityBound# */{
            ...
            /**
             * Subscribes method to be triggered when a node inside the specified entity gets appended.
             * @param {bookworm.EntityKey} entityKey
             * @param {string} [beforeMethodName]
             * @param {string} [afterMethodName]
             * @returns {bookworm.EntityBound}
             */
            bindToEntityContentAppend: function (entityKey, beforeMethodName, afterMethodName) {
                ...
                if (beforeMethodName) {
                    this._bindToEntity(
                        entityKey,
                        entityKey,
                        bookworm.Entity.EVENT_ENTITY_BEFORE_APPEND,
                        beforeMethodName,
                        'content');
                }
                ...
                if (afterMethodName) {
                    this._bindToEntity(
                        entityKey,
                        entityKey,
                        bookworm.Entity.EVENT_ENTITY_AFTER_APPEND,
                        afterMethodName,
                        'content');
                }
             ...
             * @returns {bookworm.EntityBound}
             */
            unbindFromEntityContentAppend: function (entityKey, beforeMethodName, afterMethodName) {
                dessert.isEntityKey(entityKey, "Invalid entity key");
            ...
            /**
             * Subscribes method to be triggered when the specified entity gets appended.
             * @param {bookworm.EntityKey} entityKey
             * @param {string} [beforeMethodName]
             * @param {string} [afterMethodName]
             * @returns {bookworm.EntityBound}
             */
            bindToEntityAppend: function (entityKey, beforeMethodName, afterMethodName) {
                dessert.isEntityKey(entityKey, "Invalid entity key");
            ...
            /**
             * Unsubscribes method from appending the specified entity.
             * @param {bookworm.EntityKey} entityKey
             * @param {string} [beforeMethodName]
             * @param {string} [afterMethodName]
             * @returns {bookworm.EntityBound}
             */
            unbindFromEntityAppend: function (entityKey, beforeMethodName, afterMethodName) {
                dessert.isEntityKey(entityKey, "Invalid entity key");
